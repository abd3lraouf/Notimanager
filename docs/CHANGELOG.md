...
### 🔧 Fixed
- **AppUpdater Integration**: Fixed auto-update detection
  - Added ZIP archive generation to release workflow for AppUpdater compatibility
  - AppUpdater now correctly detects and installs new releases

## [2.3.1] - 2026-02-11

### 📝 Documentation
- **Restored README Screenshots**: Fixed missing screenshot images
  - Restored menu-bar.png, settings-general.png, settings-position.png from git history
  - Fixed README image references to match existing files
  - Removed obsolete update-dialog.png reference (Sparkle-specific)
  - Updated feature description from Sparkle to AppUpdater
...
### ✨ New Features
- **Dynamic Appcast Generation**: Appcast.xml is now generated directly from CHANGELOG.md
