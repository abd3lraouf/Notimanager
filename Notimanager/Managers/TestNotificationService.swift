...
class TestNotificationService {
    ...
    func sendTestNotification(to position: NotificationPosition? = nil) {
        ...
        logger.debug("Sending test notification to \(positionName)...")
        ...
        notificationCenter.getNotificationSettings { [weak self] settings in
            ...
            DispatchQueue.main.async {
                ...
                case .authorized, .provisional, .ephemeral:
                    ...
                    self.performSendTestNotification(positionName: positionName)
                ...
                case .notDetermined:
                    ...
                    self.requestPermissionAndSend(positionName: positionName)
    ...
    private func performSendTestNotification(positionName: String) {
        // Reset tracking
        notificationWasIntercepted = false
        lastNotificationTime = Date()
    ...
    private func requestPermissionAndSend(positionName: String) {
